...
func TestFeeFilterLatest(t *testing.T) {
	...
	err = readmsg.BtcDecode(buf.Bytes(), pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		err = msg.BtcDecode(test.buf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		var msg MsgFeeFilter
		err = msg.BtcDecode(test.buf[:test.max], test.pver, BaseEncoding)
