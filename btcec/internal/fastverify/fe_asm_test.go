...
// TestFeAsmMatchesGeneric verifies that the active feMul and feSquare
// produce bit-identical limbs to the portable implementations across the
// whole loose input range, including aliased outputs. On platforms where
// feMul is the portable implementation this still passes and costs little.
