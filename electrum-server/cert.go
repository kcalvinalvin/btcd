...
import (
	...
	"crypto/elliptic"
	"crypto/rand"
	_ "crypto/sha256" // Needed for RegisterHash in init
	"crypto/x509"
	"crypto/x509/pkix"
	"encoding/pem"
	"errors"
...
// valid IP addresses.
//
// The P-256 curve is used because every TLS stack accepts it.  BoringSSL
// derived stacks, which mobile electrum clients are commonly built on, do
// not advertise the P-521 signature algorithm and fail the handshake
// against a P-521 certificate.
