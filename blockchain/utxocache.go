// Copyright (c) 2015-2023 The btcsuite developers
...
const (
	...
	//
	// The utxo cache writes large amounts of data to the database.  In order to
	// limit the size of individual database transactions, it works in batches.
	utxoBatchSizeEntries = 200_000
	...
	//
	// TODO (kcalvinalvin): At times we should just be flushing no matter how full
	// the cache is to avoid inconsistent states.
